                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contacts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="adress" id="adress" value="{{ old('adress', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile_2" id="mobile_2" value="{{ old('mobile_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="fax" id="fax" value="{{ old('fax', '') }}">
                            @if($errors->has('fax'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fax') }}
                                </div>
