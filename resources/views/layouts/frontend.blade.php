                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('tracking_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.trackings.index') }}">
                                    ...
                                    @endcan
                                    @can('about_us_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.aboutuses.index') }}">
                                            {{ trans('cruds.aboutUs.title') }}
                                        </a>
                                    @endcan
                                    @can('healty_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.healties.index') }}">
                                    ...
                                    @endcan
                                    @can('galery_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.galeries.index') }}">
