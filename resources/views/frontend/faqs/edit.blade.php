            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.faqs.update", [$faq->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="reply">{{ trans('cruds.faq.fields.reply') }}</label>
                            <textarea class="form-control ckeditor" name="reply" id="reply">{!! old('reply', $faq->reply) !!}</textarea>
                            @if($errors->has('reply'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('reply') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.faq.fields.reply_helper') }}</span>
                        </div>
                        <div class="form-group">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.faqs.storeCKEditorImages') }}', true);
