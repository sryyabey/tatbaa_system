                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.comments.update", [$comment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $comment->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="expertise" id="expertise" value="{{ old('expertise', $comment->expertise) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="comment" id="comment" value="{{ old('comment', $comment->comment) }}">
