...
class CrmDocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.crmDocuments.index', compact('crmDocuments', 'crm_customers', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.crmDocuments.create', compact('customers', 'users'));
    }
    ...
    public function edit(CrmDocument $crmDocument)
    {
        ...
        return view('admin.crmDocuments.edit', compact('crmDocument', 'customers', 'users'));
    }
