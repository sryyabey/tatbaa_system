...
class GaleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.galeries.index', compact('galeries'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.galeries.create');
    }
    ...
    public function store(StoreGaleryRequest $request)
    {
        ...
        return redirect()->route('frontend.galeries.index');
    }
    ...
    public function edit(Galery $galery)
    {
        ...
        return view('frontend.galeries.edit', compact('galery'));
    }
    ...
    public function show(Galery $galery)
    {
        ...
        return view('frontend.galeries.show', compact('galery'));
    }
