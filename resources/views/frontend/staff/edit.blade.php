                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.staff.update", [$staff->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="profession" id="profession" value="{{ old('profession', $staff->profession) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $staff->description) }}">
