...
class RandevuController extends Controller
{
    public function index()
    {
        ...
        return view('admin.randevus.index', compact('randevus'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.randevus.create', compact('customers', 'users'));
    }
    ...
    public function store(StoreRandevuRequest $request)
    {
        ...
        return redirect()->route('admin.randevus.index');
    }
    ...
    public function edit(Randevu $randevu)
    {
        ...
        return view('admin.randevus.edit', compact('customers', 'randevu', 'users'));
    }
    ...
    public function show(Randevu $randevu)
    {
        ...
        return view('admin.randevus.show', compact('randevu'));
    }
