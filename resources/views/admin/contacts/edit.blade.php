    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('map') ? 'is-invalid' : '' }}" type="text" name="map" id="map" value="{{ old('map', $contact->map) }}">
                @if($errors->has('map'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adress') ? 'is-invalid' : '' }}" type="text" name="adress" id="adress" value="{{ old('adress', $contact->adress) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_2') ? 'is-invalid' : '' }}" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', $contact->phone_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_2') ? 'is-invalid' : '' }}" type="text" name="mobile_2" id="mobile_2" value="{{ old('mobile_2', $contact->mobile_2) }}">
