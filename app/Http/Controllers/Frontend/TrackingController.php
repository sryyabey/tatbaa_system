...
class TrackingController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.trackings.index', compact('trackings', 'crm_customers', 'users', 'transactions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.trackings.create', compact('customers', 'users', 'transactions'));
    }
    ...
    public function edit(Tracking $tracking)
    {
        ...
        return view('frontend.trackings.edit', compact('customers', 'users', 'transactions', 'tracking'));
    }
